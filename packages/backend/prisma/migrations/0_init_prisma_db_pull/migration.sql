...
-- CreateTable
CREATE TABLE "public"."favorite_question" (
    "user_id" UUID NOT NULL DEFAULT auth.uid(),
    "created_at" TIMESTAMPTZ(6),
    "updated_at" TIMESTAMPTZ(6),
    "id" INTEGER NOT NULL,
    "favorite_quesion_id" UUID NOT NULL,
...
CREATE TABLE "public"."toeic" (
    ...
    CONSTRAINT "toeic_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "public"."wrong_answer_question" (
    "user_id" UUID NOT NULL DEFAULT auth.uid(),
    "history" TEXT NOT NULL,
    "created_at" TIMESTAMPTZ(6),
    "updated_at" TIMESTAMPTZ(6),
    "id" INTEGER NOT NULL,
    "wrong_answer_question_id" UUID,

    CONSTRAINT "wrong_answer_question_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "public"."favorite_question" ADD CONSTRAINT "favorite_question_favorite_quesion_id_fkey" FOREIGN KEY ("favorite_quesion_id") REFERENCES "public"."question"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."favorite_question" ADD CONSTRAINT "favorite_question_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."question" ADD CONSTRAINT "question_toeic_id_fkey" FOREIGN KEY ("toeic_id") REFERENCES "public"."toeic"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."wrong_answer_question" ADD CONSTRAINT "wrong_answer_question_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."wrong_answer_question" ADD CONSTRAINT "wrong_answer_question_wrong_answer_question_id_fkey" FOREIGN KEY ("wrong_answer_question_id") REFERENCES "public"."question"("id") ON DELETE CASCADE ON UPDATE CASCADE;
